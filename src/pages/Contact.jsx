...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/kwakyetech',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/kwakyetech/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      url: 'https://instagram.com/kwakyetech_digital',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Dribbble',
      url: 'https://dribbble.com/kwakyetech',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
